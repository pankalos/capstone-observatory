...
Copy the content of the dataset (whatever is inside the “resources” directory, (all .csv Files) )
...
See also the instructions in this folder (.png images) for more details about the general desctiption.
